...
if (NOT TARGET LibUSB::LibUSB)
    ...
    if (LibUSB_FOUND)
        ...
        if (LibUSB_LIBRARIES)
            find_library(LibUSB_LIBRARY NAMES ${LibUSB_LIBRARIES} PATHS ${LibUSB_LIBDIR} ${LibUSB_LIBRARY_DIRS})
            if (LibUSB_LIBRARY)
                set_target_properties(LibUSB::LibUSB PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION ${LibUSB_LIBRARY})
            else ()
